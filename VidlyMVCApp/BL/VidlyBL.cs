...
namespace VidlyMVCApp.BL
{
    ...
    {
        private readonly VidlyDLContext _dlContext;
        ...
        {
            if (_dlContext.Movies.Any(existingMovie =>
                existingMovie.Name.Equals(movie.Name, StringComparison.CurrentCulture))) return;
